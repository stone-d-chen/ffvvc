...
static void check_vvc_sad_8_16bpc(void)
{
    ...
    {
            int result0 = c.inter.sad[0](src0 + 128 * 2, src1 + 128 * 2, 2, 2, 8, 16);
            int result1 =  c.inter.mysad(src0 + 128 * 2, src1 + 128 * 2, 2, 2, 8, 16);
...
static void check_vvc_sad_32_16bpc(void)
{
    ...
    {
            //int result0 = c.inter.sad[0](src0 + 128 * 2, src1 + 128 * 2, 2, 2,  128, 128);
            //int result1 = c.inter.mysad128(src0 + 128 * 2, src1 + 128 * 2, 2, 2, 128, 128);
