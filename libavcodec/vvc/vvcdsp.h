...
typedef struct VVCInterDSPContext {
    ...
    int (*mysad)(const int16_t *src0, const int16_t *src1, int dx, int dy, int block_w, int block_h);
    int (*mysad16)(const int16_t *src0, const int16_t *src1, int dx, int dy, int block_w, int block_h);
    int (*mysad128)(const int16_t *src0, const int16_t *src1, int dx, int dy, int block_w, int block_h);
